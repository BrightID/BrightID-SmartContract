...
window.addEventListener('load', async () => {
    ...
    $("#addNode").click(function() {
        var nodeAddress = $("#addNode_nodeAddress").val();
        BrightID.addNode(nodeAddress, function(error, result){
            if(!error) {
                show(result);;
            }
            else{
    ...
    $("#isNode").click(function() {
        var nodeAddress = $("#isNode_nodeAddress").val();
        BrightID.isNode(nodeAddress, function(error, result){
            if(!error) {
                show(result);;
            }
            else{
    ...
    $("#addContext").click(function() {
        var contextName = $("#addContext_contextName").val();
        BrightID.addContext(contextName, function(error, result){
            if(!error) {
                show(result);;
            }
            else{
    ...
    $("#isContext").click(function() {
        var contextName = $("#isContext_contextName").val();
        BrightID.isContext(contextName, function(error, result){
            if(!error) {
                show(result);;
            }
            else{
    ...
    $("#addNodeToContext").click(function() {
        var contextName = $("#addNodeToContext_contextName").val();
        var nodeAddress = $("#addNodeToContext_nodeAddress").val();
        BrightID.addNodeToContext(contextName, nodeAddress, function(error, result){
            if(!error) {
                show(result);;
            }
            else{
    ...
    $("#isNodeInContext").click(function() {
        var contextName = $("#isNodeInContext_contextName").val();
        var nodeAddress = $("#isNodeInContext_nodeAddress").val();
        BrightID.isNodeInContext(contextName, nodeAddress, function(error, result){
            if(!error) {
                show(result);;
            }
            else{
